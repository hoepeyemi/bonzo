...
export function WhySomniaSection() {
  return (
    <section className="py-20 lg:py-28">
      <div className="container">
        <ScrollAnimation animation="fade-up">
          <div className="text-center space-y-4 mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold">Why Somnia & x402</h2>
          </div>
        </ScrollAnimation>
          ...
          <ScrollAnimation animation="stagger" className="grid gap-8 md:grid-cols-2">
            <Card className="group hover:border-primary/50 hover:shadow-lg transition-all duration-300 bg-card/50">
              <CardHeader className="space-y-4">
                ...
                <CardDescription className="text-base leading-relaxed">
                  Bonzo targets Somnia Shannon testnet and x402-style paid APIs, enabling
            ...
            <Card className="group hover:border-primary/50 hover:shadow-lg transition-all duration-300 bg-card/50">
              <CardHeader className="space-y-4">
                ...
                <CardDescription className="text-base leading-relaxed">
                  x402 enables APIs and workflows to become programmable, usage-based economic
                  primitives — a solid fit for autonomous agents and on-chain settlement.
                </CardDescription>
              </CardHeader>
            </Card>
          </ScrollAnimation>
